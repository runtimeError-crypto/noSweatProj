require(.'./projindex.html/projindex.html')
const article = document.getElementById("price");
const newsNum = document.getElementById("todaysWhatever");

const slip_id = Math.random() * 100;
console.log({ propertyName1: slip_id });

function fetch(param1) {
...
return fetch(ID("https://min-api.cryptocompare.com/data/v2/news/?lang=EN"));
